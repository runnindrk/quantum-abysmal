...
public:
    ...
    DensityOfStates::Uptr GetDensityOfStates(ProviderArchitecture arch, ProviderImplementation impl) override;

    LocalDensityOfStates::Uptr GetLocalDensityOfStates(ProviderArchitecture arch, ProviderImplementation impl) override;
};
