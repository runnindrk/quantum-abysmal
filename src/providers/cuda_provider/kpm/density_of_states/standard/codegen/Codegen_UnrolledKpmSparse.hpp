...
#ifndef QUANTUM_ABYSMAL_SRC_CUDAPROVIDER_CODEGEN_UNROLLEDKPMSPARSE_HPP
#define QUANTUM_ABYSMAL_SRC_CUDAPROVIDER_CODEGEN_UNROLLEDKPMSPARSE_HPP
                                                                                                                \
#define CODEGEN_CUDA_PROVIDER_KPM_SPARSE(lattice, a, b, x, y, threadIdx, sFirstReduceData, sSecondReduceData)   \
                                                                                                                \
    double temp[4] = {};                                                                                        \
                                                                                                                \
    ...
    sFirstReduceData[threadIdx.x] += b[ARRAY_IDX(x, y, 0, 0, 2)] * b[ARRAY_IDX(x, y, 0, 0, 2)];                 \
    sFirstReduceData[threadIdx.x] += b[ARRAY_IDX(x, y, 0, 0, 3)] * b[ARRAY_IDX(x, y, 0, 0, 3)];                 \
                                                                                                                \
    /* Second moment */                                                                                         \
    ...
    sSecondReduceData[threadIdx.x] += a[ARRAY_IDX(x, y, 0, 0, 2)] * b[ARRAY_IDX(x, y, 0, 0, 2)];                \
    sSecondReduceData[threadIdx.x] += a[ARRAY_IDX(x, y, 0, 0, 3)] * b[ARRAY_IDX(x, y, 0, 0, 3)];                \

#endif // QUANTUM_ABYSMAL_SRC_CUDAPROVIDER_CODEGEN_UNROLLEDKPMSPARSE_HPP
